...
(defmacro h2 [& args] (apply create-element "h2" args))
(defmacro h3 [& args] (apply create-element "h3" args))
(defmacro h4 [& args] (apply create-element "h4" args))
(defmacro h5 [& args] (apply create-element "h5" args))
(defmacro h6 [& args] (apply create-element "h6" args))
